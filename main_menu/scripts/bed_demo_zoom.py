...
class Demo:
	...
	def run_demo(self):
		...
		while(run == True):
			...
			raw_input("Press Enter to continue to next configuration pre-home...")
			...
			raw_input("Press Enter to continue to next configuration ... zoom")
			self._zoom(20.0)
			...
			raw_input("Press Enter to continue to next configuration pre-home...")
			self._position_rigid_arm(_CONFIG_REST_PRE)
			raw_input("Press Enter to continue to next configuration home...")
			self._position_rigid_arm(_CONFIG_REST)
			print("Done")
			self._compressor_control_pub.publish(False)
			run = False
